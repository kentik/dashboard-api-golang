...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/switch/dhcpServerPolicy/arpInspection/trustedServers] getNetworkSwitchDhcpServerPolicyArpInspectionTrustedServers", response, response.Code())
	}
}
