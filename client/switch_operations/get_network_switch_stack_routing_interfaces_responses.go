...
func (o *GetNetworkSwitchStackRoutingInterfacesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/switch/stacks/{switchStackId}/routing/interfaces] getNetworkSwitchStackRoutingInterfaces", response, response.Code())
	}
}
