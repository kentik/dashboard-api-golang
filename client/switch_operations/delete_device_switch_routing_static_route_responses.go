...
func (o *DeleteDeviceSwitchRoutingStaticRouteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /devices/{serial}/switch/routing/staticRoutes/{staticRouteId}] deleteDeviceSwitchRoutingStaticRoute", response, response.Code())
	}
}
