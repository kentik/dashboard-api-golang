...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/switch/routing/multicast/rendezvousPoints] getNetworkSwitchRoutingMulticastRendezvousPoints", response, response.Code())
	}
}
