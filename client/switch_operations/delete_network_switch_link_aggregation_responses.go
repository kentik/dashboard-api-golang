...
func (o *DeleteNetworkSwitchLinkAggregationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /networks/{networkId}/switch/linkAggregations/{linkAggregationId}] deleteNetworkSwitchLinkAggregation", response, response.Code())
	}
}
