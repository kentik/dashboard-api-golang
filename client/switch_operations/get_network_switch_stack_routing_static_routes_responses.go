...
func (o *GetNetworkSwitchStackRoutingStaticRoutesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes] getNetworkSwitchStackRoutingStaticRoutes", response, response.Code())
	}
}
