...
func (o *GetDeviceSwitchRoutingInterfaceDhcpReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /devices/{serial}/switch/routing/interfaces/{interfaceId}/dhcp] getDeviceSwitchRoutingInterfaceDhcp", response, response.Code())
	}
}
