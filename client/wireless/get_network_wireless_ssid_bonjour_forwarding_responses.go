...
func (o *GetNetworkWirelessSsidBonjourForwardingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/wireless/ssids/{number}/bonjourForwarding] getNetworkWirelessSsidBonjourForwarding", response, response.Code())
	}
}
