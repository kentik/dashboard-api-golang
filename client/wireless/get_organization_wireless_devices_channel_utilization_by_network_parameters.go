...
// NewGetOrganizationWirelessDevicesChannelUtilizationByNetworkParams creates a new GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams object,
...
func NewGetOrganizationWirelessDevicesChannelUtilizationByNetworkParams() *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	return &GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetOrganizationWirelessDevicesChannelUtilizationByNetworkParamsWithTimeout creates a new GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams object
...
// NewGetOrganizationWirelessDevicesChannelUtilizationByNetworkParamsWithContext creates a new GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams object
...
// NewGetOrganizationWirelessDevicesChannelUtilizationByNetworkParamsWithHTTPClient creates a new GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams object
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithDefaults() *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithTimeout(timeout time.Duration) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithContext(ctx context.Context) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithHTTPClient(client *http.Client) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithEndingBefore adds the endingBefore to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithEndingBefore(endingBefore *string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetEndingBefore(endingBefore *string) {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithInterval(interval *int64) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetInterval(interval)
	return o
}

// SetInterval adds the interval to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetInterval(interval *int64) {
	o.Interval = interval
}

// WithNetworkIds adds the networkIds to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithNetworkIds(networkIds []string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetNetworkIds(networkIds []string) {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithOrganizationID(organizationID string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithPerPage(perPage *int64) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetPerPage(perPage *int64) {
	o.PerPage = perPage
}

// WithSerials adds the serials to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithSerials(serials []string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetSerials(serials []string) {
	o.Serials = serials
}

// WithStartingAfter adds the startingAfter to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithStartingAfter(startingAfter *string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithT0(t0 *string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetT0(t0)
	return o
}

// SetT0 adds the t0 to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetT0(t0 *string) {
	o.T0 = t0
}

// WithT1 adds the t1 to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithT1(t1 *string) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
	o.SetT1(t1)
	return o
}

// SetT1 adds the t1 to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetT1(t1 *string) {
	o.T1 = t1
}

// WithTimespan adds the timespan to the get organization wireless devices channel utilization by network params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WithTimespan(timespan *float32) *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) SetTimespan(timespan *float32) {
	o.Timespan = timespan
}

// WriteToRequest writes these params to a swagger request
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
...
// bindParamGetOrganizationWirelessDevicesChannelUtilizationByNetwork binds the parameter networkIds
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) bindParamNetworkIds(formats strfmt.Registry) []string {
...
// bindParamGetOrganizationWirelessDevicesChannelUtilizationByNetwork binds the parameter serials
func (o *GetOrganizationWirelessDevicesChannelUtilizationByNetworkParams) bindParamSerials(formats strfmt.Registry) []string {
	serialsIR := o.Serials
