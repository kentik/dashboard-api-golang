...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/wireless/ssids/{number}/firewall/l3FirewallRules] getNetworkWirelessSsidFirewallL3FirewallRules", response, response.Code())
	}
}
