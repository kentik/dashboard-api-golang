...
// NewGetOrganizationWirelessDevicesChannelUtilizationByDeviceParams creates a new GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams object,
...
func NewGetOrganizationWirelessDevicesChannelUtilizationByDeviceParams() *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	return &GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetOrganizationWirelessDevicesChannelUtilizationByDeviceParamsWithTimeout creates a new GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams object
...
// NewGetOrganizationWirelessDevicesChannelUtilizationByDeviceParamsWithContext creates a new GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams object
...
// NewGetOrganizationWirelessDevicesChannelUtilizationByDeviceParamsWithHTTPClient creates a new GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams object
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithDefaults() *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithTimeout(timeout time.Duration) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithContext(ctx context.Context) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithHTTPClient(client *http.Client) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithEndingBefore adds the endingBefore to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithEndingBefore(endingBefore *string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetEndingBefore(endingBefore *string) {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithInterval(interval *int64) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetInterval(interval)
	return o
}

// SetInterval adds the interval to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetInterval(interval *int64) {
	o.Interval = interval
}

// WithNetworkIds adds the networkIds to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithNetworkIds(networkIds []string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetNetworkIds(networkIds []string) {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithOrganizationID(organizationID string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithPerPage(perPage *int64) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetPerPage(perPage *int64) {
	o.PerPage = perPage
}

// WithSerials adds the serials to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithSerials(serials []string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetSerials(serials []string) {
	o.Serials = serials
}

// WithStartingAfter adds the startingAfter to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithStartingAfter(startingAfter *string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithT0(t0 *string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetT0(t0)
	return o
}

// SetT0 adds the t0 to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetT0(t0 *string) {
	o.T0 = t0
}

// WithT1 adds the t1 to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithT1(t1 *string) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
	o.SetT1(t1)
	return o
}

// SetT1 adds the t1 to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetT1(t1 *string) {
	o.T1 = t1
}

// WithTimespan adds the timespan to the get organization wireless devices channel utilization by device params
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WithTimespan(timespan *float32) *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams {
...
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) SetTimespan(timespan *float32) {
	o.Timespan = timespan
}

// WriteToRequest writes these params to a swagger request
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
...
// bindParamGetOrganizationWirelessDevicesChannelUtilizationByDevice binds the parameter networkIds
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) bindParamNetworkIds(formats strfmt.Registry) []string {
...
// bindParamGetOrganizationWirelessDevicesChannelUtilizationByDevice binds the parameter serials
func (o *GetOrganizationWirelessDevicesChannelUtilizationByDeviceParams) bindParamSerials(formats strfmt.Registry) []string {
	serialsIR := o.Serials
