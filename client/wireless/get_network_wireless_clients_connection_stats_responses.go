...
func (o *GetNetworkWirelessClientsConnectionStatsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/wireless/clients/connectionStats] getNetworkWirelessClientsConnectionStats", response, response.Code())
	}
}
