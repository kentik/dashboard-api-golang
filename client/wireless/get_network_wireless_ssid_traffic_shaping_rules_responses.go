...
func (o *GetNetworkWirelessSsidTrafficShapingRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/wireless/ssids/{number}/trafficShaping/rules] getNetworkWirelessSsidTrafficShapingRules", response, response.Code())
	}
}
