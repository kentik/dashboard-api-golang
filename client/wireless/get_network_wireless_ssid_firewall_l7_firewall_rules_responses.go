...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/wireless/ssids/{number}/firewall/l7FirewallRules] getNetworkWirelessSsidFirewallL7FirewallRules", response, response.Code())
	}
}
