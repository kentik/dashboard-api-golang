...
func (o *GetOrganizationWirelessDevicesEthernetStatusesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/wireless/devices/ethernet/statuses] getOrganizationWirelessDevicesEthernetStatuses", response, response.Code())
	}
}
