...
func (o *GetNetworkWirelessSsidSplashSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/wireless/ssids/{number}/splash/settings] getNetworkWirelessSsidSplashSettings", response, response.Code())
	}
}
