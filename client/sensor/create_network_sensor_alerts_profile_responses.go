...
func (o *CreateNetworkSensorAlertsProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /networks/{networkId}/sensor/alerts/profiles] createNetworkSensorAlertsProfile", response, response.Code())
	}
}
...
/*
CreateNetworkSensorAlertsProfileOKBodyRecipients List of recipients that will receive the alert.
...
/*
CreateNetworkSensorAlertsProfileParamsBodyRecipients List of recipients that will receive the alert.
