...
func (o *GetNetworkSensorAlertsProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/sensor/alerts/profiles/{id}] getNetworkSensorAlertsProfile", response, response.Code())
	}
}
...
/*
GetNetworkSensorAlertsProfileOKBodyRecipients List of recipients that will receive the alert.
