...
func (o *GetNetworkSensorAlertsCurrentOverviewByMetricReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/sensor/alerts/current/overview/byMetric] getNetworkSensorAlertsCurrentOverviewByMetric", response, response.Code())
	}
}
