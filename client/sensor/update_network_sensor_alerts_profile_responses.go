...
func (o *UpdateNetworkSensorAlertsProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /networks/{networkId}/sensor/alerts/profiles/{id}] updateNetworkSensorAlertsProfile", response, response.Code())
	}
}
...
/*
UpdateNetworkSensorAlertsProfileOKBodyRecipients List of recipients that will receive the alert.
...
/*
UpdateNetworkSensorAlertsProfileParamsBodyRecipients List of recipients that will receive the alert.
