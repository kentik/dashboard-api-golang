...
func (o *GetNetworkSmDeviceDeviceCommandLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/sm/devices/{deviceId}/deviceCommandLogs] getNetworkSmDeviceDeviceCommandLogs", response, response.Code())
	}
}
