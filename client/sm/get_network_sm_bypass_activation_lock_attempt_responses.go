...
func (o *GetNetworkSmBypassActivationLockAttemptReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/sm/bypassActivationLockAttempts/{attemptId}] getNetworkSmBypassActivationLockAttempt", response, response.Code())
	}
}
