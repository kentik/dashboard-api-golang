...
func (o *DeleteNetworkSmUserAccessDeviceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /networks/{networkId}/sm/userAccessDevices/{userAccessDeviceId}] deleteNetworkSmUserAccessDevice", response, response.Code())
	}
}
