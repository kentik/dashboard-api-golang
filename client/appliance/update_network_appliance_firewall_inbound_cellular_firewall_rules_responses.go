...
func (o *UpdateNetworkApplianceFirewallInboundCellularFirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /networks/{networkId}/appliance/firewall/inboundCellularFirewallRules] updateNetworkApplianceFirewallInboundCellularFirewallRules", response, response.Code())
	}
}
