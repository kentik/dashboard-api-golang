...
func (o *GetNetworkApplianceTrafficShapingUplinkSelectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/appliance/trafficShaping/uplinkSelection] getNetworkApplianceTrafficShapingUplinkSelection", response, response.Code())
	}
}
