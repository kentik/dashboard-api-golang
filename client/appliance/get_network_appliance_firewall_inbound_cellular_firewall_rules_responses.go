...
func (o *GetNetworkApplianceFirewallInboundCellularFirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/appliance/firewall/inboundCellularFirewallRules] getNetworkApplianceFirewallInboundCellularFirewallRules", response, response.Code())
	}
}
