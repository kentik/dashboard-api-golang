...
func (o *DeleteNetworkApplianceStaticRouteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /networks/{networkId}/appliance/staticRoutes/{staticRouteId}] deleteNetworkApplianceStaticRoute", response, response.Code())
	}
}
