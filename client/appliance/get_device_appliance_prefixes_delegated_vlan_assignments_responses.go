...
func (o *GetDeviceAppliancePrefixesDelegatedVlanAssignmentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /devices/{serial}/appliance/prefixes/delegated/vlanAssignments] getDeviceAppliancePrefixesDelegatedVlanAssignments", response, response.Code())
	}
}
