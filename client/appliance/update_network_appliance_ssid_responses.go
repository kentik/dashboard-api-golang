...
func (o *UpdateNetworkApplianceSsidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /networks/{networkId}/appliance/ssids/{number}] updateNetworkApplianceSsid", response, response.Code())
	}
}
...
func (o *UpdateNetworkApplianceSsidBody) validateDot11w(formats strfmt.Registry) error {
	...
	if o.Dot11w != nil {
		if err := o.Dot11w.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("updateNetworkApplianceSsid" + "." + "dot11w")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("updateNetworkApplianceSsid" + "." + "dot11w")
			}
			return err
		}
	}
...
func (o *UpdateNetworkApplianceSsidBody) contextValidateDot11w(ctx context.Context, formats strfmt.Registry) error {
...
swagger:model UpdateNetworkApplianceSsidParamsBodyDot11w
*/
...
func (o *UpdateNetworkApplianceSsidParamsBodyDot11w) UnmarshalBinary(b []byte) error {
	var res UpdateNetworkApplianceSsidParamsBodyDot11w
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
