...
func (o *GetNetworkApplianceFirewallOneToManyNatRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/appliance/firewall/oneToManyNatRules] getNetworkApplianceFirewallOneToManyNatRules", response, response.Code())
	}
}
