...
func (o *GetNetworkAppliancePrefixesDelegatedStaticsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/appliance/prefixes/delegated/statics] getNetworkAppliancePrefixesDelegatedStatics", response, response.Code())
	}
}
