...
func (o *GetNetworkTrafficShapingDscpTaggingOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/trafficShaping/dscpTaggingOptions] getNetworkTrafficShapingDscpTaggingOptions", response, response.Code())
	}
}
