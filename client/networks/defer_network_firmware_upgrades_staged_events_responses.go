...
func (o *DeferNetworkFirmwareUpgradesStagedEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /networks/{networkId}/firmwareUpgrades/staged/events/defer] deferNetworkFirmwareUpgradesStagedEvents", response, response.Code())
	}
}
