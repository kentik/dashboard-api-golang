...
func (o *UpdateNetworkWebhooksPayloadTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /networks/{networkId}/webhooks/payloadTemplates/{payloadTemplateId}] updateNetworkWebhooksPayloadTemplate", response, response.Code())
	}
}
