...
func (o *DeleteNetworkFirmwareUpgradesStagedGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /networks/{networkId}/firmwareUpgrades/staged/groups/{groupId}] deleteNetworkFirmwareUpgradesStagedGroup", response, response.Code())
	}
}
