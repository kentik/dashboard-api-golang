...
func (o *RollbacksNetworkFirmwareUpgradesStagedEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /networks/{networkId}/firmwareUpgrades/staged/events/rollbacks] rollbacksNetworkFirmwareUpgradesStagedEvents", response, response.Code())
	}
}
