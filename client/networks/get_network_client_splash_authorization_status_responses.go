...
func (o *GetNetworkClientSplashAuthorizationStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/clients/{clientId}/splashAuthorizationStatus] getNetworkClientSplashAuthorizationStatus", response, response.Code())
	}
}
