...
func (o *GetNetworkTrafficShapingApplicationCategoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /networks/{networkId}/trafficShaping/applicationCategories] getNetworkTrafficShapingApplicationCategories", response, response.Code())
	}
}
