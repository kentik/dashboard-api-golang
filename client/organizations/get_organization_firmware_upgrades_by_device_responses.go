...
func (o *GetOrganizationFirmwareUpgradesByDeviceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/firmware/upgrades/byDevice] getOrganizationFirmwareUpgradesByDevice", response, response.Code())
	}
}
