...
func (o *DeleteOrganizationBrandingPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /organizations/{organizationId}/brandingPolicies/{brandingPolicyId}] deleteOrganizationBrandingPolicy", response, response.Code())
	}
}
