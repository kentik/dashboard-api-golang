...
func (o *GetOrganizationInventoryOnboardingCloudMonitoringImportsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/inventory/onboarding/cloudMonitoring/imports] getOrganizationInventoryOnboardingCloudMonitoringImports", response, response.Code())
	}
}
