...
func (o *GetOrganizationPolicyObjectsGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/policyObjects/groups/{policyObjectGroupId}] getOrganizationPolicyObjectsGroup", response, response.Code())
	}
}
