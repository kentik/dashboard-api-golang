...
func (o *GetOrganizationBrandingPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/brandingPolicies/{brandingPolicyId}] getOrganizationBrandingPolicy", response, response.Code())
	}
}
