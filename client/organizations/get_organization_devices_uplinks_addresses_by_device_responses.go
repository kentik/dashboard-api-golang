...
func (o *GetOrganizationDevicesUplinksAddressesByDeviceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/devices/uplinks/addresses/byDevice] getOrganizationDevicesUplinksAddressesByDevice", response, response.Code())
	}
}
