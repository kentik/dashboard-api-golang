...
func (o *GetOrganizationEarlyAccessFeaturesOptInsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/earlyAccess/features/optIns] getOrganizationEarlyAccessFeaturesOptIns", response, response.Code())
	}
}
