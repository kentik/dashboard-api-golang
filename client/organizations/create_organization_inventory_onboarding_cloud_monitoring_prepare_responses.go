...
func (o *CreateOrganizationInventoryOnboardingCloudMonitoringPrepareReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /organizations/{organizationId}/inventory/onboarding/cloudMonitoring/prepare] createOrganizationInventoryOnboardingCloudMonitoringPrepare", response, response.Code())
	}
}
