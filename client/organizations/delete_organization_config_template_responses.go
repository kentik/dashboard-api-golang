...
func (o *DeleteOrganizationConfigTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /organizations/{organizationId}/configTemplates/{configTemplateId}] deleteOrganizationConfigTemplate", response, response.Code())
	}
}
