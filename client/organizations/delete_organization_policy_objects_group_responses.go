...
func (o *DeleteOrganizationPolicyObjectsGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /organizations/{organizationId}/policyObjects/groups/{policyObjectGroupId}] deleteOrganizationPolicyObjectsGroup", response, response.Code())
	}
}
