...
func (o *GetOrganizationFirmwareUpgradesByDeviceParams) WithUpgradeStatuses(upgradeStatuses []string) *GetOrganizationFirmwareUpgradesByDeviceParams {
	o.SetUpgradeStatuses(upgradeStatuses)
	return o
}
...
func (o *GetOrganizationFirmwareUpgradesByDeviceParams) SetUpgradeStatuses(upgradeStatuses []string) {
	o.UpgradeStatuses = upgradeStatuses
}
...
func (o *GetOrganizationFirmwareUpgradesByDeviceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UpgradeStatuses != nil {

		// binding items for upgradeStatuses
		joinedUpgradeStatuses := o.bindParamUpgradeStatuses(reg)

		// query array param upgradeStatuses
		if err := r.SetQueryParam("upgradeStatuses", joinedUpgradeStatuses...); err != nil {
			return err
		}
	}
...
// bindParamGetOrganizationFirmwareUpgradesByDevice binds the parameter upgradeStatuses
func (o *GetOrganizationFirmwareUpgradesByDeviceParams) bindParamUpgradeStatuses(formats strfmt.Registry) []string {
	upgradeStatusesIR := o.UpgradeStatuses

	var upgradeStatusesIC []string
	for _, upgradeStatusesIIR := range upgradeStatusesIR { // explode []string

		upgradeStatusesIIV := upgradeStatusesIIR // string as string
		upgradeStatusesIC = append(upgradeStatusesIC, upgradeStatusesIIV)
	}

	// items.CollectionFormat: ""
	upgradeStatusesIS := swag.JoinByFormat(upgradeStatusesIC, "")

	return upgradeStatusesIS
}
