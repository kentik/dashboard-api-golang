...
func (o *GetOrganizationDevicesUplinksLossAndLatencyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/devices/uplinksLossAndLatency] getOrganizationDevicesUplinksLossAndLatency", response, response.Code())
	}
}
