...
func (o *GetOrganizationFirmwareUpgradesParams) WithProductTypes(productTypes []string) *GetOrganizationFirmwareUpgradesParams {
...
// bindParamGetOrganizationFirmwareUpgrades binds the parameter productTypes
func (o *GetOrganizationFirmwareUpgradesParams) bindParamProductTypes(formats strfmt.Registry) []string {
