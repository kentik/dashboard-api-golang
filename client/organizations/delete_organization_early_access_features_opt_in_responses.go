...
func (o *DeleteOrganizationEarlyAccessFeaturesOptInReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /organizations/{organizationId}/earlyAccess/features/optIns/{optInId}] deleteOrganizationEarlyAccessFeaturesOptIn", response, response.Code())
	}
}
