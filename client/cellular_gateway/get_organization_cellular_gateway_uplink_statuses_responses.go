...
func (o *GetOrganizationCellularGatewayUplinkStatusesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /organizations/{organizationId}/cellularGateway/uplink/statuses] getOrganizationCellularGatewayUplinkStatuses", response, response.Code())
	}
}
